...
<head>
    ...
    <link href="${APP_PATH}/static/css/dm-notif-style.css" rel="stylesheet" />
    <script type="text/javascript" src="${APP_PATH}/static/js/dm_notify.js"></script>
</head>
<body>
...
<script type="text/javascript">
    ...
    function build_emps_table(result){
        ...
        $.each(emps,function(index,item){
            ...
            var empIdTd = $("<td></td>").append(item.empId).addClass("text-center");
            var empNameTd = $("<td></td>").append(item.empName).addClass("text-center");
            var genderTd = $("<td></td>").append(item.gender=='M'?"男":"女").addClass("text-center");
            var emailTd = $("<td></td>").append(item.email).addClass("text-center");
            var deptNameTd = $("<td></td>").append(item.department.deptName).addClass("text-center");
            /**
             <button class="">
    ...
    $(document).on("click",".delete_btn",function(){
        ...
        if(confirm("确认删除【"+empName+"】吗？")){
            ...
            $.ajax({
                ...
                success:function(result){
//                    alert(result.msg);
                    dm_notification(result.msg,'green',8000);
                    //回到本页
                    to_page(currentPage);
                }
            });
